...
export default function DetailsPage() {
  ...
  let missions = data?.ship?.missions;
          ...
          return (
            <div key={key} id={styles.backgroundBox}>
              <>
                ...
                <div id={styles.basicInfoValue}>
                  {data?.ship[key] || "Unknown"}
                </div>
              </>
            </div>
          );
  ...
  return (
    <div id={styles.content}>
      ...
      <div id={styles.mainInfo}>
        <div id={styles.title}>{data?.ship?.name || "Name non existant"}</div>
        <div id={styles.type}>{data?.ship?.type || "Name non existant"}</div>
      </div>
      {/* basic info */}
